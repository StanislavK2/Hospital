...
public class SignUpScreen extends AppCompatActivity{
    ...
    //String newFormat = data.getData().toString().replace(".jpg", ".jpeg");//Uri.parse(newFormat);
    @Override
                                    ...
                                    public void onComplete(@NonNull Task<AuthResult> task) {
                                        if (task.isSuccessful()) {
                                            ...
                                            if (resultUri != null) {
                                                ...
                                                StorageReference Uploader = storage.getReference().child("Profile_Photo/" + UUID.randomUUID().toString() + ".jpeg");
